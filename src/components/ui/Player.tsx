  ...
  return (
    <div
        ...
        <div className="space-y-2">
          <div className="relative">
            <div className="overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
              <div
                className="w-1/2 h-2 bg-cyan-500 dark:bg-cyan-400"
                role="progressbar"
            ...
            <div className="absolute flex items-center justify-center w-4 h-4 -mt-2 -ml-2 bg-white rounded-full shadow ring-cyan-500 dark:ring-cyan-400 ring-2 left-1/2 top-1/2">
      ...
      <div className="flex items-center bg-slate-50 text-slate-500 dark:bg-slate-600 dark:text-slate-200 rounded-b-xl">
        ...
        <button
          type="button"
          className="flex items-center justify-center flex-none w-20 h-20 mx-auto -my-2 bg-white rounded-full shadow-md text-slate-900 dark:bg-slate-100 dark:text-slate-700 ring-1 ring-slate-900/5"
          aria-label="Pause">
