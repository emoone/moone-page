...
export default function RootLayout({
   ...
   * 서버 사이드 렌더링을 사용하는 경우, 일반적으로 서버와 클라이언트가 다른 내용을 렌더링할 때 경고가 표시됨.
   * 그러나 매우 드물게 정확히 일치시키는 게 힘들거나 불가능합니다.
   * 예를 들어 타임 스탬프 같은 경우 서버와 클라이언트에서는 다를 것으로 예상됩니다.
   * suppressHydrationWarning을 true로 설정하면, React는 어트리뷰트와 그 엘리먼트 내용의 불일치에 대해 경고하지 않습니다.
